    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        create.setOnClickListener(v -> {
            if (filteredFriendList.stream().filter(Friend::isSelected).count() >= 2) {
                ...
                Toast.makeText(GroupChatAddingMember.this, "Select at least 2 friends to create a group", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void createGroup() {
        ...
        groupChatApiService.createGroupChat(groupNameText, netId, new GroupChatApiService.GroupChatCallback() {
            ...
            public void onSuccess(String response) {
                Toast.makeText(GroupChatAddingMember.this, "Group created successfully!", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(GroupChatAddingMember.this, ChatList.class);
                startActivity(intent);
            }
